...
class ImagesAdapter(uriList:ArrayList<Uri>,parentLifecycleOwner: LifecycleOwner) :
    BaseAdapter<Uri, ImageItemViewHolder>(uriList,parentLifecycleOwner.lifecycle) {
